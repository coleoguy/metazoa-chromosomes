...
file.list <- list.files(path = "../results/exponential-prior-full-model/mentor_results",
                        full.names = TRUE)
...
# save final table
write.csv(ess_table, file="../results/exponential-prior-full-model/ess_summary.csv", row.names = FALSE)
