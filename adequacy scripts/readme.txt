These scripts evaluate the way that tree size or sampling impacts our rate 
estimates. 

pull of the prior - emp.R: This file leverages the scarab dataset and makes rate
